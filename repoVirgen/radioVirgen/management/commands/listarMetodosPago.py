...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        metodo1 = MetodoPago.objects.create(tipo="Tarjeta", numTarjeta="12345", cvc="123",
                                            nombreTitular="Jaime Alemany")  # acaba de entrar por la puerta conforme escribo esto
